...
server <- function(input, output){
  ...
  color_df <- read.csv("../data/preprocessed/color_category.csv")
  data2$color_category <- ifelse(data2$anlaegsbet%in% color_df$color_category, data2$anlaegsbet, "other")
  data2 <- left_join(data2, color_df, by="color_category")
